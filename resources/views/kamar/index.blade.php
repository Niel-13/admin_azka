                                ...
                                @forelse ($kamars as $kamar)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('kamar.edit', $kamar->id) }}" class="text-amber-600 hover:text-amber-900 mr-2">Edit</a>
                                            <button type="button" 
